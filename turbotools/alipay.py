...
if __name__ == "__main__":
    ...
    alipay = AliPay(
        appid="2016082100304001",  # APP ID
        app_notify_url="http://projectsedus.com/",  # 回调URL
        app_private_key_path="/Users/shengan/Downloads/secret_key_tools_RSA_macosx/RSA密钥/应用私钥2048.txt",  # 私钥的路径
        alipay_public_key_path="/Users/shengan/Downloads/secret_key_tools_RSA_macosx/RSA密钥/支付宝公钥.txt",  # 支付宝的公钥
        debug=True,  # 默认False,
    ...
    url = alipay.direct_pay(
        subject="测试订单",  # 标题
        out_trade_no="201702021222",  # 订单标号
        total_amount=0.01  # 费用
    )
